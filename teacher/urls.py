...
from .views import (
    ...
    performance_analysis_download, create_course, delete_course
)
...
urlpatterns = [
    ...
    path('courses/delete_course/<int:pk>', delete_course, name='delete_course'),
    path('courses/create_course', create_course, name='create_course'),
    ...
    path('course-performance/download-results/<int:pk>/<int:pk2>/<str:exam_id>', student_download_results,
         name='download_results'),
    path('course-performance-analysis/<int:pk>', performance_analysis, name='performance_Analysis'),
    path('course-performance-analysis/download/<int:pk>', performance_analysis_download,
         name='performance_analysis_download'),
